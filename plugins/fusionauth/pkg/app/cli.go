...
type CLI struct {
	...
	Fetch           FetchCmd           `cmd:"" help:"fetch fusionauth data"`
	Transform       TransformCmd       `cmd:"" help:"transform fusionauth data"`
	ExportTransform ExportTransformCmd `cmd:"" help:"export default transform template"`
	Exec            ExecCmd            `cmd:"" help:"fetch and transform fusionauth data" default:"withargs"`
