...
import (
	...
	"github.com/aserto-dev/ds-load/plugins/fusionauth/pkg/app"
...
func main() {
	...
	defaultConfigPath := "~/.config/ds-load/cfg/fusionauth.yaml"

	yamlLoader := kongyaml.NewYAMLResolver("fusionauth")
	options := []kong.Option{
