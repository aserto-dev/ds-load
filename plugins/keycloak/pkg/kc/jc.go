...
func NewKeyCloudClient(ctx context.Context, apiKey string) (*KeyCloudClient, error) {
...
func (c *KeyCloudClient) ListDirectories(ctx context.Context) ([]any, error) {
...
func (c *KeyCloudClient) ListUsers(ctx context.Context) ([]*User, error) {
...
func (c *KeyCloudClient) ListGroups(ctx context.Context, groupType GroupType) ([]*Group, error) {
	var fullURL string
...
func (c *KeyCloudClient) ExpandUsersInGroup(ctx context.Context, groupID string, idLookup map[string]*BaseUser) ([]*BaseUser, error) {
...
func (c *KeyCloudClient) GetBaseUserByID(ctx context.Context, id string) (*BaseUser, error) {
...
func (c *KeyCloudClient) GetUserByID(ctx context.Context, id string) (*User, error) {
	url := baseURL + "/Systemusers/" + id + "?limit=1&skip=0"
...
func (c *KeyCloudClient) GetUserByEmail(_ context.Context, _ string) (*User, error) {
