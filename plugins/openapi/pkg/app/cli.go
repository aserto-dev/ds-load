...
type CLI struct {
	...
	Fetch           FetchCmd           `cmd:"" help:"fetch openapi data"`
	Transform       TransformCmd       `cmd:"" help:"transform openapi data"`
	ExportTransform ExportTransformCmd `cmd:"" help:"export default transform template"`
	Exec            ExecCmd            `cmd:"" help:"fetch and transform openapi data" default:"withargs"`
